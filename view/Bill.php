...
class BillInfo
{
    ...
    {
        $this->mainBody.="<form action='http://localhost/hms/Admin/index.php?pagename=cashPay' method='post'><div align='center'><table><tr><th>সার্ভিস</th> <th>প্রতি সার্ভিস মূল্য</th><th>মোট সার্ভিস</th><th>মূল্য</th></tr>";
         $sum =0;
         ...
         while($row=mysqli_fetch_row($this->bill))
        {
           ...
           $this->mainBody.="<tr ><td colspan='3' align='right'>বকেয়া</td><td >".($sum-$this->pay)."</td></tr>";
           $this->mainBody.="<tr ><td colspan='3' align='right'>পরিশোধ</td><td ><input type='text' name='pay' /></td></tr></table></div><br />";
    }
   private function setPaymentMethod()
   {
       $this->mainBody.="<div class='paymentTypeSelect' align='center'>";
          $this->mainBody.="<div class='submit'><input type='hidden' name='customerID' value='".$this->customer[0]."' /><input type='hidden' name='reservationID' value='".$this->customer[1] ."'/>"; 
