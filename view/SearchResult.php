...
class Room
 {
   private $mainBody,$result;
    ...
    {
        $this->mainBody.="<div class='middle'><form action='http://localhost/hms/index.php?pagename=reservation' method='post'>";
      ...
      $this->mainBody.="<div class='submit' align='center'><input type='submit' value='বুকিং'/></div><br /></form></div>";
    }
