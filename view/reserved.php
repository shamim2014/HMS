...
class Reservation 
{
    ...
    {
              $this->mainBody.="<div class='reserved_direct'><form action='http://localhost/hms/Admin/index.php?pagename=booked' method='post'><div class='info_name'> নাম</div><input type='text' name='customerName' /><br /><div class='info_name'>বাড়ী নং/গ্রাম</div><input type='text' name='addStreet' /><br />
          ...
          for($i=0;$i<=10;$i++)
       {
        ...
        $this->mainBody.="</select><br /><div class='submit'><input type='submit' value='জমা'/></div><br /></form></div></div></div>";
    }
