...
class PaymentSlip 
{
    private $mainBody,$customer,$bill,$roomRate,$pay;
    
    public function __construct($customerInfo,$bill,$roomRate,$pay)
     {
    ...
    {
          $this->mainBody.="<div align='center'>অতিথি   আইডি : ".$this->customer[0]."<br />বুকিং  আইডি: ".$this->customer[1]."<br />";
    ...
    private function setBill()
    {
         ...
         while($row=mysqli_fetch_row($this->bill))
        {
           ...
           $this->mainBody.="<tr ><td colspan='3' align='right'>সর্বমোট প্রদান</td><td >".$this->pay."</td></tr>";
           $this->mainBody.="<tr ><td colspan='3' align='right'>বকেয়া</td><td >".($sum-$this->pay)."</td></tr></table></div><br />";
    }
   private function setAction()
   {
         $this->mainBody.="</div><div align='center'><button type='button' onclick='printDiv(\"printableArea\")'>প্রিন্ট</button></div>"; }
