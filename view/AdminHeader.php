...
class AdminHeader 
{
        ...
        private function setMenu()
        {
            ...
            $this->menu.="<li><a href='http://localhost/hms/index.php?pagename=paymentLog'>পেমেন্ট</a></li><li><a href='http://localhost/hms/Admin/index.php?pagename=logout'>লগ  আউট</a></li>";
